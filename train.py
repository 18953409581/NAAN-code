...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    for v in model.modules():
        ...
        if isinstance(v, nn.BatchNorm2d):  # weight (no decay),不进行权重衰减
            g0.append(v.weight)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/test21.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/wood.yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--project', default='/home/hzf/code/yoloair/yoloair-main/runs/train', help='save to project/name')
